...
public class UserService {
    ...
    public User createUser(String username, String password) throws UserNameAlreadyTakenException,
        ...
        // validate inputs
        username = validationOfString(username);
        password = validationOfPassString(password);
    ...
    public String validationOfString(String word) throws NameIsNotCorrectException {
    ...
    public String validationOfPassString(String pass) throws PassIsNotCorrectException {
